...
const satisfactionData = [
  { name: 'Satisfait', value: 65, color: '#4ADE80' }, // Green
  { name: 'Neutre', value: 25, color: '#FACC15' },    // Yellow
  { name: 'Insatisfait', value: 10, color: '#F87171' }, // Red
]
  ...
  return (
    <div className="flex flex-col h-full animate-fade-in-up space-y-8">
      ...
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-gray-900">Statistiques & Performances</h2>
        <select className="bg-white border border-gray-200 text-sm rounded-lg px-4 py-2 font-medium">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <KPICard title="Temps Moyen de Résolution" value="1h 45m" change="-12%" isPositive={true} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
            <h3 className="font-bold text-slate-800 mb-6">Volume des Tickets (Hebdomadaire)</h3>
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
            <h3 className="font-bold text-slate-800 mb-6">Répartition Satisfaction Client</h3>
